...
<body>
  <form action="{{ route('loginPost') }}" method="POST">
    <div class="all_content w-100 vh-100 d-flex" style="align-items:center; justify-content:center; flex-direction:column;">
      <div class="logo"><img src="{{ asset('image\atlas-black.png') }}" alt="Atlas"></div>
